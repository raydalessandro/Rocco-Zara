...
> nel canone (`../../cartografia/regni/_voci.json`) e porta dentro la sua città reale.
>
> **Il test (Ray):** se lo *incontri*, è giusto; se lo *costruisci*, è troppo costruito.
>
> Ogni casella qui è un **seme**: si svilupperà in scheda piena (formato `_TEMPLATE.md`), un
> arco alla volta. I **trasversali** che fanno da filo in tutti gli archi sono già in cassa:
> **la Voce che torna** (cicala, ovunque ci sia un Luogo Antico) · **l'Esattore pentito** ·
> **il Cacciatore** (insegue Toraki) · **le tracce di Toraki**.

Lo **schema** di ogni arco (5 caselle): ① specchio interiore · ② porta al nodo · ③ aiuto + un seme · ④ presenza ostile locale · ⑤ un secondo che genera trama (porta una *sua* linea).

---

## Arco 1 — i Laghi del Vespro
*Como/Lario · confederazione libera · conteso · innesco; mette alla prova **Zara** (appartenere).* ✅ **fatto**
- ① **la giovane Lince** — *Popolo del Bosco* — è tutto ciò che Zara finge di essere: la sua accettazione È la posta del primo nodo.
- ② **il Custode** (testuggine) — *i Custodi (Plinio)* — sa la pietra tiepida, non il perché → le Coppelle.
- ③ **la Traghettatrice** (lontra) — *Gente delle Rive* — passaggio e riparo; sulla sua barca Cècca ruba un pegno.
- ④ **Cècca + Artiglio** (la Serpe incombe).
...
- ④ **il quinto colonna** — *i Protettori (svuotati)* — un cittadino del libero comune che lavora di nascosto per la Serpe: i liberi traditi **da dentro** (filo ricorrente).
...
- ④ **Artiglio + il Mastino + la Corte** (la Serpe è *di casa* qui: Viscardo/Bissa/Aspide).
...
- ④ **la Casa dell'Aquila** — *la Casa dell'Aquila (ottava rima estense)* — il nobile di sangue che disprezza la missione «di plebe»: blocco (legge contro sangue).
...
- ④ **le Creature della Rovina** — *Creature della Rovina (filastrocca notturna)* — gli abitanti uncanny delle rovine + il **Cacciatore** (trasversale) che qui chiude su Toraki.
...
- ④ **la rivalità che degenera** — le gare che diventano fazione + il **Cacciatore** al suo redde rationem + l'ultima mano della Serpe; **la Pantera** (Lucca, di seta) ambigua.
- ⑤ **la Gente del Mare** — *Gente del Mare (Pisa, marinaresca, «misura due volte»)* — un marinaio preciso con una **sua rotta**, che può offrire un'uscita o portar via qualcuno *(propria linea al finale)*.

---

## Note di metodo
- **Alternanza del fuoco:** gli archi mettono alla prova ora Zara ora Rocco (1 Zara · 2 Rocco · 3 Rocco-casa · 4 Zara-fondo · 5 entrambi · 6 finale). Lo specchio ① di ogni arco serve quel fuoco.
- **I trasversali tengono il filo:** la cicala in ogni Luogo Antico; l'Esattore che matura e **paga in Arco 3**; il Cacciatore che cresce e **chiude in 5-6**; Toraki che converge al **midpoint** e si ricongiunge al **finale**.
- **Voci già distinte:** ogni abitante eredita la voce-classe della sua città reale → nessuno parla uguale, e nessuno suona «inventato».
- **Da qui:** un arco alla volta → ogni casella diventa scheda piena. Poi un giro d'affinamento e il cast è chiuso.
