...
- Geografia **DEFINITIVA**: corridoio Prealpi→Toscana, 6 regni-comuni, faunario/società/voci, città-rovina.
- `regno/regni.json` allineato al canone narrativo (Como/Brescia/Firenze/Selva di Mezzo/Toscana).
...
- [ ] **B1. Ep01 nel `saga_graph.json`** — l'origine ricontestualizzata (Zara fugge il
      compito di Toraki → incontro a Lecco/B1 → tempesta → partenza; Rocco dal Popolo
...
- [ ] **C2. Terminus** — dove aspetta Toraki (Toscana/Volterra vs anello a Lecco). *Si
      decide definendo le storie.*
- [ ] **C3. Cast dei regni** — estrarre i personaggi (regno→classe→corporazione→individuo).
- [ ] **C4. Arco Laghi d'Occidente** — abbozzo dei ~6 episodi del primo arco.
